...
using Consumentor.Shopgun.Web.UI.Controllers;
...
namespace Consumentor.Shopgun.Web.UI
{
    public class IocConfig : IContainerConfiguration
    {
        ...
        private void ApplicationServices()
        {
            ...
            _container.RegisterComponent()
                .AsSingleton
                .AsService<IProductAdviceApplicationService>()
                .OfType<ProductAdviceApplicationService>();
        ...
        private void Controllers()
        {
            ...
            _container.RegisterComponent("Advice", typeof (AdviceController), ComponentLifestyle.Transient);

            _container.RegisterComponent("Product", typeof(ProductController), ComponentLifestyle.Transient);
            _container.RegisterComponent("Brand", typeof(BrandController), ComponentLifestyle.Transient);
            _container.RegisterComponent("Company", typeof(CompanyController), ComponentLifestyle.Transient);
            _container.RegisterComponent("Ingredient", typeof(IngredientController), ComponentLifestyle.Transient);

            _container.RegisterComponent("Concept", typeof(ConceptController), ComponentLifestyle.Transient);

            _container.RegisterComponent("ProductAdvice", typeof(ProductAdviceController), ComponentLifestyle.Transient);
            _container.RegisterComponent("BrandAdvice", typeof(BrandAdviceController), ComponentLifestyle.Transient);
            _container.RegisterComponent("CompanyAdvice", typeof(CompanyAdviceController), ComponentLifestyle.Transient);
            _container.RegisterComponent("IngredientAdvice", typeof(IngredientAdviceController), ComponentLifestyle.Transient);
            _container.RegisterComponent("CountryAdvice", typeof(CountryAdviceController), ComponentLifestyle.Transient);
            _container.RegisterComponent("ConceptAdvice", typeof(ConceptAdviceController), ComponentLifestyle.Transient);

            _container.RegisterComponent("CategoryInfo", typeof(CategoryInfoController), ComponentLifestyle.Transient);
            _container.RegisterComponent("CertificationMark", typeof(CertificationMarkController), ComponentLifestyle.Transient);
            _container.RegisterComponent("Role", typeof(RoleController), ComponentLifestyle.Transient);
            _container.RegisterComponent("User", typeof(UserController), ComponentLifestyle.Transient);
            _container.RegisterComponent("Advisor", typeof(AdvisorController), ComponentLifestyle.Transient);
            _container.RegisterComponent("AdvisorProfile", typeof(AdvisorProfileController), ComponentLifestyle.Transient);

            _container.RegisterComponent("PerformanceTest", typeof(PerformanceTestController), ComponentLifestyle.Transient);
        }
