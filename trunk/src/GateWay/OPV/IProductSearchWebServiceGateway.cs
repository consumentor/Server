...
namespace Consumentor.ShopGun.Gateway.Opv
{
    ...
    public interface IProductSearchWebServiceGateway : Consumentor.ShopGun.Gateway.IWebServiceSettings
    {
        ...
        string TestAuthorization();
        
        ProductGWO[] GetProductData(string[] eanVec);
        
        ListProductGWO[] GetProductListData(string[] eanVec);
        
        string[] GetAllAvailableEANs();
        
        string[] GetChangedProductsEANs(System.DateTime changedAfter);
    }
}
