...
namespace Consumentor.ShopGun.Gateway.Gepir
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://www.gepir.org/", TypeName="GetPartyBySSCC")]
    [System.ComponentModel.TypeConverterAttribute(typeof(System.ComponentModel.ExpandableObjectConverter))]
    public partial class GetPartyBySSCCGWO
    {
        
        /// <remarks/>
        private string requestedSscc;
        ...
        public GetPartyBySSCCGWO()
        {
        }
        
        public GetPartyBySSCCGWO(string requestedSscc, System.Collections.Generic.List<string> requestedLanguages, decimal version, bool versionSpecified)
        {
            this.requestedSscc = requestedSscc;
            this.requestedLanguages = requestedLanguages;
            this.version = version;
            this.versionSpecified = versionSpecified;
        }
        
        [System.Xml.Serialization.XmlElementAttribute(ElementName="requestedSscc")]
        public string RequestedSscc
        {
            get
            {
                return this.requestedSscc;
            }
            set
            {
                if ((this.requestedSscc != value))
                {
                    this.requestedSscc = value;
                }
            }
        }
